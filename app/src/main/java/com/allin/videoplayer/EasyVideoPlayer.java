...
public class EasyVideoPlayer extends FrameLayout
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mRetryText == null) mRetryText = context.getResources().getText(R.string.cancel);
        if (mSubmitText == null) mSubmitText = context.getResources().getText(R.string.choose);
    ...
    public void showControls() {
        if (mControlsDisabled || isControlsShown()) return;
...
//                .start();
    ...
    protected void onFinishInflate() {
        ...
        mBtnRetry = (TextView) mControlsFrame.findViewById(R.id.btn_cancel);
        ...
        mBtnSubmit = (TextView) mControlsFrame.findViewById(R.id.btn_choose);
